...
func init() {
	m.Register(func(app core.App) error {
		...
		c := core.NewBaseCollection("traffic_daily")
		...
		c.AddIndex("idx_traffic_daily_user_node_bucket", true, "user, node, bucket", "")
		c.AddIndex("idx_traffic_daily_bucket", false, "bucket", "")

		return app.Save(c)
	}, func(app core.App) error {
		c, err := app.FindCollectionByNameOrId("traffic_daily")
		if err != nil {
			return err
		}
		return app.Delete(c)
